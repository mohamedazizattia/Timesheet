...
import static tn.esprit.spring.entities.Role.CHEF_DEPARTEMENT;
...
public class TimesheetServiceImplTest {
    ...
    public void ajouterMission() {
        Mission m1= new Mission(4,"paris","paris") ;
...
//        Employe e =new Employe(1,"ismail","ismail","ismail@gmail.com",true,CHEF_DEPARTEMENT);
